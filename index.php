    ...
    <div class="row align-items-center">
      <div class="col-lg-6 fade-up">
        ...
        <div class="d-flex gap-3 flex-wrap mb-5">
          ...
          <a href="register.php" class="btn-hero-sec">Become a Vendor</a>
        </div>
...
<section class="fv-cta text-center" id="about">
  <div class="container">
    ...
    <a href="register.php" class="btn btn-light px-4 py-2 fw-600" style="border-radius:40px;color:var(--fv-pink)">Register as a vendor</a>
  </div>
</section>
